...
BASE_STYLE = (
    ...
    'GROUND CLUTTER RULE: keep the ground TRAVERSABLE — do not scatter small blocking objects '
    '(loose crates, rocks, debris piles) across walking areas. Decorate floors only with FLAT, '
    'non-blocking detail: cables and hoses lying flat, stains, painted markings, grates, '
    'manhole covers, cracks. Blocking objects belong at edges and in deliberate clusters, '
    'never sprinkled through the walkways. '
